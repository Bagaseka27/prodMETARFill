...
def get_db_path() -> str:
    app_data_dir = os.path.join(os.environ.get("LOCALAPPDATA", os.path.expanduser("~")), "METARFill")
    os.makedirs(app_data_dir, exist_ok=True)
    return os.path.join(app_data_dir, "database_metar.db")
...
def get_auth_state_path() -> str:
    app_data_dir = os.path.join(os.environ.get("LOCALAPPDATA", os.path.expanduser("~")), "METARFill")
    os.makedirs(app_data_dir, exist_ok=True)
    return os.path.join(app_data_dir, "auth_state.json")
